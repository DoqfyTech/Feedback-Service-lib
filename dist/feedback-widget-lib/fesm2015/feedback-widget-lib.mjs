...
class FeedbackWidgetLibService {
    ...
    unload() {
        ...
        (_a = document.getElementById(this.widgetScriptId)) === null || _a === void 0 ? void 0 : _a.remove();
        (_b = document.querySelector('.feedback-btn')) === null || _b === void 0 ? void 0 : _b.remove();
        (_c = document.querySelector('.feedback-modal')) === null || _c === void 0 ? void 0 : _c.remove();
        (_d = document.querySelector('.feedback-modal-backdrop')) === null || _d === void 0 ? void 0 : _d.remove();
        this.isLoaded = false;
    }
}
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(FeedbackWidgetLibService, [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
FeedbackWidgetLibComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: FeedbackWidgetLibComponent, selectors: [["lib-feedback-widget-lib"]], decls: 2, vars: 0, template: function FeedbackWidgetLibComponent_Template(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(FeedbackWidgetLibComponent, [{
            type: Component,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(FeedbackWidgetLibModule, [{
            type: NgModule,
            args: [{
                    declarations: [
