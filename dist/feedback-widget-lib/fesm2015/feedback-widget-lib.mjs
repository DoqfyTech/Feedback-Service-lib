...
class FeedbackWidgetLibService {
    ...
    unload() {
        var _a, _b, _c;
        (_a = document.querySelector('.feedback-btn')) === null || _a === void 0 ? void 0 : _a.remove();
        (_b = document.querySelector('.feedback-modal')) === null || _b === void 0 ? void 0 : _b.remove();
        (_c = document.querySelector('.feedback-backdrop')) === null || _c === void 0 ? void 0 : _c.remove();
        this.isLoaded = false;
        this.rating = 0;
        this.imageBase64 = "";
        this.videoBase64 = "";
    ...
    createHeader(modal, backdrop) {
      ...
      <div>
        ...
        (_a = header.querySelector('#closeBtn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => this.closeModal(modal, backdrop));
        return header;
    }
    createBody() {
        var _a;
      ...
      <form class="feed-back-form">
        ...
        // Rating
        (_a = body.querySelectorAll('.feedback-stars span')) === null || _a === void 0 ? void 0 : _a.forEach(span => {
    ...
    `;
        (_a = footer.querySelector('#fb-cancel')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => this.closeModal(modal, backdrop));
        (_b = footer.querySelector('#fb-submit')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => this.submit(modal, backdrop));
        return footer;
    }
    ...
    submit(modal, backdrop) {
        ...
        const payload = {
            username: (_a = this.config) === null || _a === void 0 ? void 0 : _a.user,
            rating: this.rating,
            comment,
            improvement,
